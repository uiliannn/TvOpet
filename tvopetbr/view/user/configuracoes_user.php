    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" method="POST" action="processar_editar_user.php"
                                ...
                                <div class="col-sm-10">
                                    <select  class="form-control" name="niveis_acesso_id">
                                        ...
                                        if ($row_user['niveis_acesso_id'] == 1)
                                            echo "<option value='0'>Administrador</option> <option value='0'>Usuario</option>";
                                        else
