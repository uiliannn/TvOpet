                        ...
                        <table class="table">
                            ...
                            <?php while($rows = mysqli_fetch_assoc($resultado_recado_bd)){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="visualizar.php?id=<?php echo $rows['id']; ?>">

                                            <button type="button" class="btn btn-xs btn-primary"><i class="pe-7s-look"></i>Visualizar</button>
                                        </a>
                                        <a href="editar.php?id=<?php echo $rows['id']; ?>">
                                            <button type="button" class="btn btn-xs btn-warning"><i class="pe-7s-note"></i>Editar</button>
                                        </a>
